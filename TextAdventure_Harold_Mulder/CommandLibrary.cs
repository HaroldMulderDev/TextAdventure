    ...
    public class CommandLibrary
	{
        ...
        */
        ...
        public void initializeCommands()
        {
            ...
            commandData.Add("attack", GeneralDataLibrary.I() + "Description: \n \n" + GeneralDataLibrary.I(2) + "Attacks given target. \n \n \n" + GeneralDataLibrary.I() + "Usages: \n \n" + GeneralDataLibrary.I(2) + "'attack <target>': attacks given target with first hand weapon.");
